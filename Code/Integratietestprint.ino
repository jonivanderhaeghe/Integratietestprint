...
//   Serial.println(hond.charAt(0,2,4,6,8,10,12,14));
//   Serial.println(hond.toInt());
  
//   String hondje = hond.charAt(0);
//   hondje.toInt();

//   // charAt(index) haal een karakter uit een string met index

//   // if (SmsPortNum.charAt(0) == '0') {
//   //   String Check = "Stroomafname correct";
//   //   Serial.println("stroom correct");
//   // }
  
//   // else
//   // {
//   //   String Check = "Stroomafname niet correct";
//   //   Serial.println("stroom niet correct");
//   // }
